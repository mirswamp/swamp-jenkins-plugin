 ...
 * @author Ulli Hafner
 */
public class SwampBuildResult extends BuildResult {
    ...
    /**
     * Creates a new instance of {@link SwampBuildResult}.
     *
     * @param build
     ...
     */
    public SwampBuildResult(final Run<?, ?> build, final String defaultEncoding, final ParserResult result,
            final boolean usePreviousBuildAsReference, final boolean useStableBuildAsReference) {
        this(build, defaultEncoding, result, usePreviousBuildAsReference, useStableBuildAsReference,
                SwampBuildResultAction.class);
    }
     ...
     */
    protected SwampBuildResult(final Run<?, ?> build, final String defaultEncoding, final ParserResult result,
            final boolean usePreviousBuildAsReference, final boolean useStableBuildAsReference,
            final Class<? extends ResultAction<SwampBuildResult>> actionType) {
    ...
    SwampBuildResult(final Run<?, ?> build, final BuildHistory history,
...
*/
    ...
    public String getSummary() {
        return "FindBugs: " + createDefaultSummary(/*FindBugsDescriptor.RESULT_URL*/"my url", getNumberOfAnnotations(), getNumberOfModules());
    }
/*
    @Override
...
*/
    ...
    public String getDisplayName() {
        return SwampBuildResult.class.getName();
    }

    @Override
    protected Class<? extends ResultAction<? extends BuildResult>> getResultActionType() {
        return SwampBuildResultAction.class;
    }
}